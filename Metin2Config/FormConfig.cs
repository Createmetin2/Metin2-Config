...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
		...
		{
			this.cboxTargetShadow.SelectedIndex = this.cboxTargetShadow.Items.Count - 1;
			this.cboxShadowQuality.SelectedIndex = this.cboxShadowQuality.Items.Count - 1;
			this.cboxEffect.SelectedIndex = 0;
			this.cboxPrivateShop.SelectedIndex = 0;
			this.cboxDropItem.SelectedIndex = 0;
			this.cboxGamma.SelectedIndex = 2;
...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
		...
		private void btnOK_Click(object sender, EventArgs e)
		{
			...
			if (cboxLocale.SelectedIndex != -1 &&
				cboxLocale.SelectedIndex < m_LocaleList.Count)
			{
				var locale = m_LocaleList.ElementAt(cboxLocale.SelectedIndex);
				using (var localeFile = new StreamWriter(m_LocaleFileName))
					localeFile.Write($"{locale.code} {locale.name}");
			}
		...
		{
			this.BackColor = m_DarkModeEnabled ? SystemColors.Control : Color.FromArgb(22, 22, 24);
			this.pboxDarkMode.Image = m_DarkModeEnabled ?
				global::Metin2Config.Properties.Resources.night_off : global::Metin2Config.Properties.Resources.night_on;
		...
		private void rbtnWindowMode_Click(object sender, EventArgs e)
		{
			MessageBox.Show(GetString("CONFIG_STRING_SPEEDLOW"), GetString("CONFIG_STRING_NOTIC"));
		}

		private void rbtnOutIME_Click(object sender, EventArgs e)
		{
			MessageBox.Show(GetString("CONFIG_STRING_SPEEDLOW"), GetString("CONFIG_STRING_NOTIC"));
		}
		...
		private void cboxResolution_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			if (cboxResolution.SelectedIndex != -1 &&
				cboxResolution.SelectedIndex < m_ScreenSettingsList.Count)
			{
